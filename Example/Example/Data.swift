...
enum Data {
    ...
    static let polygon = try! Polygon(exterior: GEOSwift.Polygon.LinearRing(points: [GEOSwift.Point(x: 40, y: 50.0), GEOSwift.Point(x: 200, y: 21), GEOSwift.Point(x: 120, y: 210), GEOSwift.Point(x: 40, y: 50)]),
                                      holes: [
