...
final class BoundableTests_XYZ: XCTestCase {
    let boundables: [any Boundable<XYZ>] = [
        ...
        try! LineString(points: [Point(x: 1, y: 2, z: 0), Point(x: 3, y: 4, z: 1)]),
        MultiLineString(lineStrings: [
            try! LineString(points: [Point(x: 1, y: 2, z: 0), Point(x: 3, y: 4, z: 1)]),
            try! LineString(points: [Point(x: 5, y: 6, z: 2), Point(x: 7, y: 8, z: 3)])
        ]),
    ...
    func testBoundaryLine() {
        let line = try! LineString(points: [Point(x: 0, y: 0, z: 0), Point(x: 1, y: 0, z: 1)])
