...
// MARK: - XYM Test Fixtures

public struct GEOSTestFixtures_XYM {
    public static let lineString0 = try! LineString(coordinates: Array(repeating: XYM(0, 0, 0), count: 2))
    ...
    public static let lineString2 = try! LineString(coordinates: [
        ...
        XYM(1, 0, 1),
        XYM(1, 1, 2)])
    public static let multiLineString0 = MultiLineString<XYM>(lineStrings: [])
    ...
    public static let linearRing0 = try! Polygon.LinearRing(coordinates: Array(repeating: XYM(0, 0, 0), count: 4))
    ...
    public static let geometryConvertibles: [any GeometryConvertible<XYM>] = [
        Point<XYM>.testValue1,
