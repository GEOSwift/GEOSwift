...
/// Base test case for Operations tests using XYZ coordinates.
/// Provides all common fixtures converted from XYZM to XYZ.
class OperationsTestCase_XYZ: XCTestCase {
    // MARK: - Points
