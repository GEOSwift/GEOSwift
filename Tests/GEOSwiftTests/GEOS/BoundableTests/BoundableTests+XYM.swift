...
final class BoundableTests_XYM: XCTestCase {
    let boundables: [any Boundable<XYM>] = [
        Point(x: 1, y: 2, m: 0),
        MultiPoint(points: [Point(x: 1, y: 2, m: 0), Point(x: 3, y: 4, m: 1)]),
        try! LineString(points: [Point(x: 1, y: 2, m: 0), Point(x: 3, y: 4, m: 1)]),
        MultiLineString(lineStrings: [
            try! LineString(points: [Point(x: 1, y: 2, m: 0), Point(x: 3, y: 4, m: 1)]),
            try! LineString(points: [Point(x: 5, y: 6, m: 2), Point(x: 7, y: 8, m: 3)])
        ]),
    ...
    func testBoundaryLine() {
        let line = try! LineString(points: [Point(x: 0, y: 0, m: 0), Point(x: 1, y: 0, m: 1)])
