...
func makeCoordinates<C: CoordinateType>(from geometry: GEOSObject) throws -> [C] {
...
func makeGEOSObject<C: CoordinateType>(
    ...
    let sequence = try makeCoordinateSequence(with: context, coordinates: coordinates)
